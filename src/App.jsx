...
function LoginScreen({ onLogin }) {
  return (
    <div style={{ maxWidth: '390px', margin: '0 auto', fontFamily: 'sans-serif', textAlign: 'center', paddingTop: '120px' }}>
      <h1 style={{ fontSize: '32px', fontWeight: 700, margin: '0 0 8px' }}>Kolda</h1>
      <p style={{ color: '#888', fontSize: '15px', margin: '0 0 48px' }}>Войди чтобы добавить объявление</p>
      <button onClick={onLogin} style={{ display: 'flex', alignItems: 'center', gap: '12px', margin: '0 auto', padding: '14px 24px', borderRadius: '12px', border: '1px solid #ddd', background: '#fff', fontSize: '15px', fontWeight: 500, cursor: 'pointer' }}>
