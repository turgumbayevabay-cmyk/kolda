...
function LoginScreen({ onBack }) {
  return (
    <div style={{ maxWidth: '390px', margin: '0 auto', fontFamily: 'sans-serif', textAlign: 'center', paddingTop: '80px', padding: '80px 24px 0' }}>
      <span onClick={onBack} style={{ display: 'block', textAlign: 'left', cursor: 'pointer', fontSize: '18px', marginBottom: '40px' }}>←</span>
      <h1 style={{ fontSize: '28px', fontWeight: 700, margin: '0 0 8px' }}>Войти в Kolda</h1>
      <p style={{ color: '#888', fontSize: '14px', margin: '0 0 40px' }}>Чтобы добавить объявление нужен аккаунт</p>
      ...
      <p style={{ color: '#bbb', fontSize: '12px', marginTop: '24px' }}>После входа нажми "+ Добавить" снова</p>
    </div>
  )
}
